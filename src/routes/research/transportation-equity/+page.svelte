<script>
	...
	const fns = [
		'Rafael H. M. Pereira and Alex Karner, “Transportation Equity,” in <i>International Encyclopedia of Transportation</i>, vol. 1, ed. Roger Vickerman (2021), <a href="http://dx.doi.org/10.1016/B978-0-08-102671-7.10053-3" target="_blank">DOI</a>.',
		'Alex Karner, Rafael H. M. Pereira, and Steven Farber, “Advances and Pitfalls in Measuring Transportation Equity,” in <i>Transportation</i>, ahead of print, January 12, 2024. <a href="https://doi.org/10.1007/s11116-023-10460-7" target="_blank">DOI</a>.',
		'Institute of Transportation Engineers (ITE), <i>Trip Generation</i>, 8th Edition (ITE, 2008).',
		'Reid Ewing et al., “Traffic Generated by Mixed-Use Developments—Six-Region Study Using Consistent Built Environmental Measures,” in <i>Journal of Urban Planning and Development</i> 137, no. 3 (2011): 248–61, <a href="https://doi.org/10.1061/(ASCE)UP.1943-5444.0000068" target="_blank">DOI</a>. '
	];
...
<main>
	...
	<div class="text">
		...
		<p>	
			We began by assessing <strong><span style="border-bottom: solid 3px var(--brandPink);">current conditions</span></strong> in five station areas: Arbutus (Vancouver), Cooksville (Mississauga), McKernan-Belgravia (Edmonton), Northfield (Waterloo), and Panama (Brossard). We used census data for low-income households and business register data for employment, to calculate baseline accessibility scores at the dissemination area level. We then created three development scenarios: 
		</p>

		<ul>
			<li>
				The <strong><span style="border-bottom: solid 3px var(--brandMedBlue);">current trajectory</span></strong>, which follows existing growth patterns within the TOD (the 800-metre radius around the transit station)
			</li>
			<li>
				The <strong><span style="border-bottom: solid 3px var(--brandMedGreen);">optimized scenario</span></strong>, which uses more optimal land use changes within the TOD
			</li>
			<li>	
				A <strong><span style="border-bottom: solid 3px var(--brandPurple);">general growth scenario</span></strong> which assumes the same population and job growth as in the current trajectory but distributes it across the census subdivisions (municipalities) in proportion to their existing populations, rather than concentrating it in the station area 
			</li>
		</ul>
